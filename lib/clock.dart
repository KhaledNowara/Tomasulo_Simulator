...
class Clock {
  ...
  void initialize() {
    ...
    instructionQueue.instructionQueue.add(
        Instruction.load(target: 'R2', operand2Reg: 'R1', addressOffset: 8));
    instructionQueue.instructionQueue.add(
        Instruction.add(target: 'R3', operand1Reg: 'R2', operand2Reg: 'R2'));
    instructionQueue.instructionQueue.add(
        Instruction.mult(target: 'R4', operand1Reg: 'R3', operand2Reg: 'R3'));
    instructionQueue.instructionQueue.add(
        Instruction.sub(target: 'R8', operand1Reg: 'R4', operand2Reg: 'R4'));
    instructionQueue.instructionQueue.add(
        Instruction.load(target: 'R5', operand2Reg: 'R1', addressOffset: 4));
    instructionQueue.instructionQueue.add(
        Instruction.div(target: 'R6', operand1Reg: 'R4', operand2Reg: 'R5'));
    instructionQueue.instructionQueue.add(Instruction.store(
        operand1Reg: 'R6', operand2Reg: 'R1', addressOffset: 12));
  }
  ...
  bool finished() {
    bool f = instructionQueue.instructionQueue.isEmpty &&
        addStation.isEmpty() &&
        multStation.isEmpty() &&
        storeBuffer.isEmpty() &&
        loadBuffer.isEmpty() &&
